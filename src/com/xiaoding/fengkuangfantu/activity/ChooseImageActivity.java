...
public class ChooseImageActivity extends BaseActivity {
    ...
    private void initClicks() {
        ...
        chooseGridView.setOnItemClickListener(new OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view,
                ...
                // TODO Auto-generated method stub
                if (!isTurn) {
                    ToastUtil.threadShow(ChooseImageActivity.this, mHandler,
                ...
                if (!chooseName.isEmpty() && !chooseName.equals(nameString)) {
                    ...
                    isTurning = false;
                    if (totalCount == 2) {
                        ToastUtil.threadShow(ChooseImageActivity.this,
                        ...
                        if (currentLevel == levelNum) {
                            // showNextPartAlert();
                            ToastUtil.threadShow(ChooseImageActivity.this,
                                    mHandler, R.string.choose_image_all_sucess);
                        }
                    }
                }
            }
        ...
        turnNextTextView.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (currentLevel == levelNum) {
                    // gotoNextPart();
                    ToastUtil.threadShow(ChooseImageActivity.this, mHandler,
                            R.string.choose_image_all_sucess);
                } else {
                    currentLevel++;
    ...
    private void showChooseName() {
        ...
        String name = getResources().getString(R.string.choose_image_title)
                + chooseName;
    ...
    private void initLevel(String text) {
        ...
        chooseAdapter = new ChooseAdapter(getApplicationContext(), mHandler,
                chooseList, chooseGridView, true);
