...
public class FindImageActivity extends BaseActivity {
    ...
    private void initClicks() {
        ...
        findGridView.setOnItemClickListener(new OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view,
                ...
                // TODO Auto-generated method stub
                if (!isTurn) {
                    ToastUtil.threadShow(FindImageActivity.this, mHandler,
                            R.string.turn_image_first);
                    return;
                }
                if (isTurning) {
                    return;
                ...
                coverFramlayout = (FrameLayout) view
                        .findViewById(R.id.coverFramlayout);
                defaultImageView = (ImageView) view
                        .findViewById(R.id.defaultImageView);
                ...
                if (clickCount == 1) {
                    ...
                    if (!lastImageName.isEmpty()
                            && !lastImageName.equals(nameString)) {
                        mHandler.postDelayed(new Runnable() {

                            @Override
                            public void run() {
                                // TODO Auto-generated method stub
                                showDefault(lastCoverFramlayout,
                                        lastDefaultImageView, true);
                                showDefault(coverFramlayout, defaultImageView,
                                        true);
            ...
            public void onClick(View v) {
                ...
                if (currentLevel < levelNum) {
                    ...
                    initLevel(getResources()
                            .getString(R.string.turn_image_text));
                }
            }
        });
    }
    ...
    protected void showNextPartAlert() {
        ...
        RelativeLayout returnRelativeLayout = (RelativeLayout) window
                .findViewById(R.id.returnRelativeLayout);
        RelativeLayout cancelRelativeLayout = (RelativeLayout) window
                .findViewById(R.id.cancelRelativeLayout);
        RelativeLayout okRelativeLayout = (RelativeLayout) window
                .findViewById(R.id.okRelativeLayout);
        ...
        timerRunnable = new Runnable() {
            ...
            public void run() {
                ...
                if (time == 0) {
                    ...
                    ToastUtil.threadShow(FindImageActivity.this, mHandler,
                            R.string.turn_image_fail);
                    initLevel(getResources().getString(
                            R.string.turn_image_retry));
                } else {
                    findProgressBar.setProgress(time);
    ...
    private void initLevel(String text) {
        ...
        findAdapter = new FindAdapter(getApplicationContext(), mHandler,
                findist, findGridView, true);
