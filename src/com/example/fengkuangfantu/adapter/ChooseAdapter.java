...
//	private GridViewCountrySyncImageLoader gridViewSyncImageLoader;
	...
	public ChooseAdapter(Context context, Handler handler, ArrayList<FindEntity> findist, GridView gridView, boolean isFirst) {
...
//	}
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if (convertView == null) {
			convertView = LayoutInflater.from(context).inflate(R.layout.choose_grid_item, null);	
